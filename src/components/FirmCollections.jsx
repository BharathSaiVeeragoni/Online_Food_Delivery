...
const FirmCollections = () => {
    ...
    return (
        <div className="pt-5">
            <h3 className="fs-2 pb-2"><b>Restaurants with online food delivery in Warangal</b></h3>
                            ...
                            return (
                                <Link to={`/products/${item._id}/${item.firmName}`} className="link" key={item._id}>
                                    <div className="zoomEffect">
                                        <div className="firmGroupBox card">
                                            <div className="firmGroup card-body">
                                                <img className="" src={`${API_URL}/uploads/${item.image}`} alt={item.firmName} />
                                                <div className="firmOffer">{item.offer}</div>
                                            </div>
                                            <div className="firmDetails card-body">
